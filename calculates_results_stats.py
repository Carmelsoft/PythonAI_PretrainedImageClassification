...
def calculates_results_stats(results_dic):
    ...
    if (b != 0):
        objective_1_a = (a/b) * 100
    else:
        objective_1_a = 0
        
    if (d != 0):
        objective_1_b = (c/d) * 100
    else:
        objective_1_b = 0  
    ...
    results_stats_dic['n_notdogs_img'] = z - b
    ...
    results_stats_dic['pct_match'] = objective_3
    results_stats_dic['pct_correct_dogs'] = objective_1_a
    results_stats_dic['pct_correct_breed'] = objective_2
    results_stats_dic['pct_correct_notdogs'] = objective_1_b
